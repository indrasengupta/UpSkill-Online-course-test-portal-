...
//id, courseTitle, prerequisite, syallbus, duration,
	...
	public CourseContentDto(int courseId, String courseTitle, String tags, String prerequisite, String syallbus,
			String duration, Double courseFee, String faculty, String video1, String video1Name, String video2,
			String video2Name, int lecturerId, List<Videos> videosList, List<ReviewDto> reviewDtoList, float avgRating) {
	...
	public CourseContentDto(int courseId, String courseTitle, String prerequisite, String syallbus, String duration,
			Double courseFee, String faculty, String video1, String video1Name, String video2, String video2Name,
			List<Videos> videosList, List<ReviewDto> reviewDtoList, float avgRating) {
		this.courseId = courseId;
		this.courseTitle = courseTitle;
		this.prerequisite = prerequisite;
		this.syallbus = syallbus;
	...
	public String toString() {
		return String.format(
				"CourseDetailsDto [courseId=%s, courseTitle=%s, tags=%s, prerequisite=%s, syallbus=%s, duration=%s, courseFee=%s, faculty=%s, video1=%s, video1Name=%s, video2=%s, video2Name=%s, lecturerId=%s, videosList=%s, reviewDtoList=%s, avgRating=%s]",
				courseId, courseTitle, tags, prerequisite, syallbus, duration, courseFee, faculty, video1, video1Name,
				video2, video2Name, lecturerId, videosList, reviewDtoList, avgRating);
	}
